						...
						<div class="panel-body">
                            <form method="post" action="data_edit_s.php" enctype="multipart/form-data">
										<div class="form-group">
                                            <label>Id</label>
                                            <input class="form-control" name='id' value="<?echo $row['id'];?>" readonly>
                                        </div>
										<div class="form-group">
                                            <label>Angkatan</label>
                                            <input class="form-control" name='angkatan' value="<?echo $row['angkatan'];?>"  required>
                                        </div>
										<div class="form-group">
                                            <label>Nama</label>
                                            <input class="form-control" name='nama' value="<?echo $row['nama'];?>"  required>
                                        </div>
										<div class="form-group">
                                            <label>NIM</label>
                                            <input class="form-control" name='nim' value="<?echo $row['nim'];?>"  required>
                                        </div>
										<div class="form-group">
                                            <label>Jurusan</label>
                                            <input class="form-control" name='jurusan' value="<?echo $row['jurusan'];?>"  required>
                                        </div>
